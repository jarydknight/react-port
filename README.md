  ...
  * [Questions](#questions)
  ...
  The purpose of this project is to professional portfolio using React.
  ...
  * Navigate to the root folder and run ```npm start``` 
  ...
  [Github Pages Deployment](https://jarydknight.github.io/react-port/)
